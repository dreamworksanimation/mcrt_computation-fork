# mcrt_computation - part of the [MoonRay](https://github.com/OpenMoonRay/openmoonray) project
...
This repository contains the mcrt computation component for Arras.
